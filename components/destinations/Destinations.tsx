...
const Destinations = () => {
  return (
    <div className="text-center mt-14 md:mt-28 pb-10 md:pb-20">
      <h3 className={`text-[#5E6282] text-lg font-semibold ${poppins.className}`}>Top Selling</h3>
      <h2 className={`text-2xl md:text-5xl font-bold text-[#14183E] mt-4 mb-14 ${volkhov.className}`}>Top Destinations</h2>
