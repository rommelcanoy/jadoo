      ...
      <div className='flex-1 flex justify-center'>
        <div className='flex items-center relative w-[370px] h-full -mr-24'>
          <div className='rounded-3xl shadow-xl p-6 flex-none bg-white z-10'>
            ...
            <div className='shadow-xl rounded-2xl flex z-10 bg-white bottom-[110px] absolute -right-36 w-[300px] p-6 gap-3'>
          ...
          <Image src={blue_orb} alt="blue orb" className='absolute -top-5 -right-20' />
        </div>
      </div>
    </div>
  )
